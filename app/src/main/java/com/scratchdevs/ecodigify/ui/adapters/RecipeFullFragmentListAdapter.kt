...
class RecipeFullFragmentListAdapter(
    ...
    androidx.recyclerview.widget.RecyclerView.Adapter<RecipeFullFragmentListAdapter.ViewHolder>() {
    ...
    class ViewHolder(
        ...
        var recyclerView: RecyclerView =
            view.findViewById(R.id.recipe_full_ingredients_recycler_view)
