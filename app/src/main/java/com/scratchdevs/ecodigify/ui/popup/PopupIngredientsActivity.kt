 ...
 */
class PopupIngredientsActivity : androidx.appcompat.app.AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var ingredient =
            intent.getParcelableExtra<Ingredient>("INGREDIENT")
        ...
        ingredient?.let {
            ...
            val adapter =
                ArrayAdapter(this, android.R.layout.simple_spinner_item, possibleNamesWithAdd)
            ...
            private fun showAddNewItemDialog() {
                ...
                builder.setPositiveButton(getString(R.string.apply_button_text)) { _, _ ->
                    ...
                    if (newItemName.isNotBlank()) {
                        ingredient?.possibleNames =
                            ingredient?.possibleNames?.plus(listOf(newItemName))!!
